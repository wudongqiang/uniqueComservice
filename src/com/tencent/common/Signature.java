...
public class Signature {
    ...
    public static String getSign4Json(Map<String,Object> map){
        ArrayList<String> list = new ArrayList<String>();
        for(Map.Entry<String,Object> entry:map.entrySet()){
            if(entry.getValue()!=""){
                list.add(entry.getKey() + "=" + entry.getValue() + "&");
        ...
        String result = sb.toString();
        String normalStr = result;
        result += "key=" + Configure.getKey();
        //Util.log("Sign Before MD5:" + result);
        result = normalStr + "sign=" + MD5.MD5Encode(result).toUpperCase();
        //Util.log("Sign Result:" + result);
        return result;
    }
    
    public static String getSign4JsonMain(Map<String,Object> map){
        ArrayList<String> list = new ArrayList<String>();
        for(Map.Entry<String,Object> entry:map.entrySet()){
            if(entry.getValue()!=""){
                list.add(entry.getKey() + "=" + entry.getValue() + "&");
        ...
        String result = sb.toString();
        //Util.log("Sign Before MD5:" + result);
        result =  "sign=" + SHA1.SHA1(result).toUpperCase();
        //Util.log("Sign Result:" + result);
        return result;
    }
