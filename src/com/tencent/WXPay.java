...
public class WXPay {
    ...
    static{
		File cert = new File(BeanListener.BASE_PATH,"apiclient_cert.p12");
		WXPay.initSDKConfiguration(key, appID, mchID, null, cert.getPath(), mchID);
    }
     ...
     * @throws Exception
     */
    public static String buildPayOrderService(BeforePayReqData PayReqData) throws Exception{
        return new BuildPayOrderService().request(PayReqData);
    }
