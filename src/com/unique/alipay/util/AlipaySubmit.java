...
import com.unique.alipay.config.AlipayConfig;
import com.unique.alipay.sign.RSA;
import com.unique.alipay.util.httpClient.HttpProtocolHandler;
import com.unique.alipay.util.httpClient.HttpRequest;
import com.unique.alipay.util.httpClient.HttpResponse;
import com.unique.alipay.util.httpClient.HttpResultType;
...
//    }
     ...
     * @return
     */
    public static String buildRequest(String subject, String body, String price,String orderNo,String returnUrl,String showUrl){
		...
		sParaTemp.put("notify_url", FileUtil.readProperties("comservice.properties", "comservicePath") + "notify.do?method=alipay");
...
//        return buildRequest(sParaTemp);
        return JsonUtil.toJSONString(buildRequest(sParaTemp));
    }
